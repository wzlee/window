package com.eaglec.win.ucenter.api;
...
import com.eaglec.win.ucenter.client.Utils;
...
public class UC extends HttpServlet{
	...
	private String doAnswer(HttpServletRequest request, HttpServletResponse response){
		...
		$code = Utils.uc_authcode($code, "DECODE", ResourceBundle.getBundle("config").getString("oauth.client_secret"), 3600);
		...
		if($action.equals("test")) {
			...
			Cookie cookie = new Cookie("_uid",$get.get("uid"));
