...
//	if($.cookie('plat_account')){
//		$('#account_input').text($.cookie('plat_account'));
//		//console.log($('#account_input').val());
//		$('#pwd_input').focus();
//	}else{
//		$('#account_input').focus();
//	}
    $('#ajax_login_form').submit(function() {
        $(this).ajaxSubmit({
            ...
            data:{
            	...
            	password:$.md5($.trim($('#pwd_input').val()))
        	}
        });
        return false;
    });
    ...
    var loginCallback = function(data) {
        ...
        if (data.success) {
//        	$.cookie('plat_account',$('#account_input').val());
            $('#js_login_input').html('<p>' + data.message + '</p>').show();
