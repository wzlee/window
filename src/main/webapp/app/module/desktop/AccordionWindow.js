...
Ext.define('Plat.module.AccordionWindow', {
            ...
            store: Ext.create('Ext.data.TreeStore', {
                root: {
                    ...
                    children:[{
                        ...
                        expanded:true,
                        children:[
                            { text:'唐总', iconCls:'user', leaf:true },
                            { text:'李志威', iconCls:'user', leaf:true },
                            { text:'翟大任', iconCls:'user', leaf:true },
                            { text:'倪经理', iconCls:'user', leaf:true },
                            { text:'李武', iconCls:'user', leaf:true },
                            { text:'沈陈荣', iconCls:'user', leaf:true },
                            { text:'夏文龙', iconCls:'user', leaf:true },
