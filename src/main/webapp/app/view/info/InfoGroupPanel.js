Ext.define('plat.view.info.InfoGroupPanel',{
extend: 'Ext.container.Container',
   	alias : 'widget.infogrouppanel',
   ...
   /* requires: [
    ...
    initComponent: function(){
    	//未删除的发送
    	this.sendStore = Ext.create('plat.store.info.InfoGroupStore',{
    		storeId : 'sendGroupStore'
    	});
    	Ext.apply(this.sendStore.proxy.extraParams, {type : 0});
    	this.sendStore.loadPage(1);
    	
    	//已删除
    	this.deleteStore = Ext.create('plat.store.info.InfoGroupStore', {
    		storeId : 'deleteGroupStore'
    	});
...
//	        { xtype :'checkcolumn',text: '#',align:'center',flex:1, dataIndex : 'id' },
	        ...
	        { text: '接收人',align:'center',flex:1, dataIndex: 'receiver',renderer:function(text){
	        	switch(text){
	        		case '1' : return '全部用户';
	        		break;
	        		case '2' : return '企业用户';
