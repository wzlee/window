Ext.define('plat.view.layout.ManagePanelView',{
	...
	initComponent:function(){
	    ...
	    Ext.Ajax.request({
    			...
    			success:function(response){
    				...
    				var store = Ext.create('Ext.data.Store',{storeId:record.data.id,autoSync:false,model:'plat.model.ManageModel',sorters: [{property: 'id',direction: 'desc'}]});
    				var cellSelectionModel = Ext.create('Ext.selection.CellModel', {
						listeners: {
	...
	//							this.getManageGrid().down('#removeButton').setDisabled(selections.length == 0);
				    ...
				    var cellEditing = Ext.create('Ext.grid.plugin.CellEditing', {pluginId:'rowEditing',clicksToEdit: 2});
